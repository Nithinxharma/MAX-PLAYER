...
val MIGRATION_16_17 = object : Migration(16, 17) {
  override fun migrate(db: SupportSQLiteDatabase) {
    db.execSQL("CREATE TABLE IF NOT EXISTS `extension_repositories` (`url` TEXT NOT NULL, `name` TEXT NOT NULL, `description` TEXT, `lastSync` INTEGER NOT NULL, PRIMARY KEY(`url`))")
    db.execSQL("CREATE TABLE IF NOT EXISTS `installed_extensions` (`pkgName` TEXT NOT NULL, `name` TEXT NOT NULL, `version` TEXT NOT NULL, `versionCode` INTEGER NOT NULL, `description` TEXT, `iconUrl` TEXT, `repositoryUrl` TEXT, `isEnabled` INTEGER NOT NULL, `localFilePath` TEXT, `classesFile` TEXT, PRIMARY KEY(`pkgName`))")
    db.execSQL("CREATE TABLE IF NOT EXISTS `cinehub_library` (`url` TEXT NOT NULL, `apiName` TEXT NOT NULL, `title` TEXT NOT NULL, `posterUrl` TEXT, `type` INTEGER NOT NULL, `watchStatus` INTEGER NOT NULL, `addedAt` INTEGER NOT NULL, PRIMARY KEY(`url`))")
  }
}

val MIGRATION_17_18 = object : Migration(17, 18) {
  override fun migrate(db: SupportSQLiteDatabase) {
    db.execSQL("ALTER TABLE `installed_extensions` ADD COLUMN `lang` TEXT")
  }
}
