...
class AppearancePreferences(
  ...
  val enableGlassPlayerControls = preferenceStore.getBoolean("enable_glass_player_controls", true)
  val enableGlassSeekbarBackground = preferenceStore.getBoolean("enable_glass_seekbar_background", true)
  ...
  val enableExpandingOnScreenControls = preferenceStore.getBoolean("enable_expanding_on_screen_controls", true)
  ...
  val bottomRightControls =
    preferenceStore.getString(
      ...
      "PICTURE_IN_PICTURE,ASPECT_RATIO,QUALITY",
    )

  val bottomLeftControls =
    preferenceStore.getString(
      "bottom_left_controls",
      "METADATA,LOCK_CONTROLS,BACKGROUND_PLAYBACK,SCREEN_ROTATION,PLAYBACK_SPEED,REPEAT_MODE,SHUFFLE,AB_LOOP",
    )

  val portraitBottomControls =
    preferenceStore.getString(
      "portrait_bottom_controls",
      "METADATA,QUALITY,DECODER,AUDIO_TRACK,SUBTITLES,PLAYBACK_SPEED,REPEAT_MODE,SHUFFLE,SCREEN_ROTATION,LOCK_CONTROLS,BACKGROUND_PLAYBACK,PICTURE_IN_PICTURE,ASPECT_RATIO,MORE_OPTIONS",
    )

  val moreSheetControls =
    preferenceStore.getString(
      "more_sheet_controls",
      "SCREEN_ROTATION,METADATA,DECODER,AUDIO_TRACK,SUBTITLES,PLAYBACK_SPEED,REPEAT_MODE,SHUFFLE,VIDEO_ZOOM,FRAME_NAVIGATION,ASPECT_RATIO,PICTURE_IN_PICTURE,LOCK_CONTROLS,SLEEP_TIMER",
    )
