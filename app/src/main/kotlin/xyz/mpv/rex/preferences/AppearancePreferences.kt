...
class AppearancePreferences(
  ...
  val topRightControls =
    preferenceStore.getString(
      "top_right_controls",
      "CURRENT_CHAPTER,METADATA,DECODER,AUDIO_TRACK,SUBTITLES,MORE_OPTIONS",
    )
  ...
  val portraitBottomControls =
    preferenceStore.getString(
      ...
      "METADATA,DECODER,AUDIO_TRACK,SUBTITLES,PLAYBACK_SPEED,REPEAT_MODE,SHUFFLE,SCREEN_ROTATION,LOCK_CONTROLS,BACKGROUND_PLAYBACK,PICTURE_IN_PICTURE,ASPECT_RATIO,MORE_OPTIONS",
    )
